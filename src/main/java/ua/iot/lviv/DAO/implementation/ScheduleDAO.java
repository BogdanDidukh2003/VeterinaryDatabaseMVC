...
public class ScheduleDAO implements DAO<Schedule, Integer> {
    private static final String GET_ALL = "SELECT * FROM bogdan_didukh.schedule";
    private static final String GET_BY_ID = "SELECT * FROM bogdan_didukh.schedule WHERE id=?";
    private static final String CREATE = "INSERT bogdan_didukh.schedule "
            + "(id, doctor_id, time_start, time_end, week_day) VALUES (?, ?, ?, ?, ?)";
    private static final String UPDATE = "UPDATE bogdan_didukh.schedule"
            + " SET doctor_id=?, time_start=?, time_end=?, week_day=? WHERE id=?";
    private static final String DELETE = "DELETE FROM bogdan_didukh.schedule WHERE id=?";

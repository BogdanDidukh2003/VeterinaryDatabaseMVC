...
public class ClientHasPetDAO implements DAO<ClientHasPet, Integer> {
    private static final String GET_ALL = "SELECT * FROM bogdan_didukh.client_has_pet";
    private static final String GET_BY_ID = "SELECT * FROM bogdan_didukh.client_has_pet WHERE id=?";
    private static final String CREATE = "INSERT bogdan_didukh.client_has_pet "
            + "(id, client_id, pet_id) VALUES (?, ?, ?)";
    private static final String UPDATE = "UPDATE bogdan_didukh.client_has_pet"
            + " SET client_id=?, pet_id=? WHERE id=?";
    private static final String DELETE = "DELETE FROM bogdan_didukh.client_has_pet WHERE id=?";

...
public class DoctorDAO implements DAO<Doctor, Integer> {
    private static final String GET_ALL = "SELECT * FROM bogdan_didukh.doctor";
    private static final String GET_BY_ID = "SELECT * FROM bogdan_didukh.doctor WHERE id=?";
    private static final String CREATE = "INSERT bogdan_didukh.doctor "
            + "(id, first_name, name, last_name, year_of_birth, speciality) VALUES (?, ?, ?, ?, ?, ?)";
    private static final String UPDATE = "UPDATE bogdan_didukh.doctor"
            + " SET first_name=?, name=?, last_name=?, year_of_birth=?, speciality=? WHERE id=?";
    private static final String DELETE = "DELETE FROM bogdan_didukh.doctor WHERE id=?";

...
public class DiplomaDAO implements DAO<Diploma, Integer> {
    private static final String GET_ALL = "SELECT * FROM bogdan_didukh.diploma";
    private static final String GET_BY_ID = "SELECT * FROM bogdan_didukh.diploma WHERE id=?";
    private static final String CREATE = "INSERT bogdan_didukh.diploma "
            + "(id, university, date, seria, number, doctor_id) VALUES (?, ?, ?, ?, ?, ?)";
    private static final String UPDATE = "UPDATE bogdan_didukh.diploma"
            + " SET university=?, date=?, seria=?, number=?, doctor_id=? WHERE id=?";
    private static final String DELETE = "DELETE FROM bogdan_didukh.diploma  WHERE id=?";

...
public class PetDAO implements DAO<Pet, Integer> {
    private static final String GET_ALL = "SELECT * FROM bogdan_didukh.pet";
    private static final String GET_BY_ID = "SELECT * FROM bogdan_didukh.pet WHERE id=?";
    private static final String CREATE = "INSERT bogdan_didukh.pet "
            + "(id, animal_species_id, name, weight_kg, length_cm, date_of_birth) VALUES (?, ?, ?, ?, ?, ?)";
    private static final String UPDATE = "UPDATE bogdan_didukh.pet"
            + " SET animal_species_id=?, name=?, weight_kg=?, length_cm=?, date_of_birth=? WHERE id=?";
    private static final String DELETE = "DELETE FROM bogdan_didukh.pet WHERE id=?";
